  ...
  return (
    <PageCanvas className="max-w-7xl mx-auto">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr_1fr]">
        <Card className="p-6">
          <h2 className="text-lg font-bold tracking-[-0.04em]">1. 브랜드 무드 / 키워드</h2>
        ...
        <Card className="p-6">
          <h2 className="text-lg font-bold tracking-[-0.04em]">2. 컬러 팔레트</h2>
        ...
        <Card className="p-6">
          <h2 className="text-lg font-bold tracking-[-0.04em]">3. 타이포그래피</h2>
          <div className="mt-5 space-y-4">
            <div><p className="text-xs text-fb-muted">Headline</p><p className="text-4xl font-bold tracking-[-0.07em]">2042년 8월</p></div>
            <div><p className="text-xs text-fb-muted">Section title</p><p className="text-xl font-bold tracking-[-0.05em]">FIRE 계산 순자산</p></div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        <Card className="p-6">
          <h2 className="text-lg font-bold tracking-[-0.04em]">4. 핵심 컴포넌트</h2>
        ...
        <Card className="p-6">
          <h2 className="text-lg font-bold tracking-[-0.04em]">5. 수치 표현 계층</h2>

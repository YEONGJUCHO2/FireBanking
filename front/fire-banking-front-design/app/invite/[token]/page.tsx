    ...
    <MobileAppShell>
      ...
      <div className="space-y-5 px-5 pb-6">
        <section className="fb-card p-6 text-center">
          ...
          <h1 className="mt-2 text-2xl font-bold tracking-[-0.06em] text-fb-ink">배우자 워크스페이스에 참여해요</h1>
        ...
        <section className="fb-card p-5">
          ...
          <h2 className="mt-1 text-xl font-bold tracking-[-0.05em] text-fb-ink">정확하지 않아도 괜찮아요.</h2>

  ...
  return (
    <PageCanvas className="max-w-[1680px] mx-auto">
      ...
      <section className="mt-4">
        <div className="mb-4 flex items-center gap-2"><span className="flex size-6 items-center justify-center rounded-full bg-fb-green text-xs font-bold text-white">7</span><div><h2 className="text-lg font-bold tracking-[-0.04em]">데스크톱 대응안</h2><p className="text-sm text-fb-muted">PC에서도 한눈에 확인하고 관리할 수 있어요.</p></div></div>
        <DesktopDashboard />
      </section>
    </PageCanvas>
  )

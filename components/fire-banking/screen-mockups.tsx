    ...
    <div>
      {label ? (
        <div className="mb-3 flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-bold tracking-normal text-fb-ink">{label}</p>
  ...
  return (
    <div className="flex h-full flex-col px-5 py-6">
      ...
      <section className="mt-12">
        ...
        <h1 className="mt-3 text-[2rem] font-bold leading-tight tracking-normal text-fb-ink">부부가 함께<br />순자산과 경제적 자유<br />진척을 확인해요.</h1>
    ...
    <div>
      ...
      <div className="space-y-5 px-5 pb-6">
        <section className="fb-card p-5 text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold tracking-normal text-fb-ink">Fire Banking에 초대받았어요!</h1>

import { AssetsScreenPreview, BrandLockup, DashboardScreenPreview, DesktopDashboard, HistoryScreenPreview, InviteScreenPreview, LiteScreenPreview, LoginScreenPreview, OnboardingScreenPreview, PageCanvas, PhoneMockup, ResultBridgeScreenPreview, SettingsScreenPreview, SimulatorScreenPreview, TogetherScreenPreview } from '@/components/fire-banking'
    ...
    <div data-screen-label="showcase">
      <PageCanvas className="max-w-[1680px] mx-auto">
        ...
        <div className="fb-scrollbar-none flex gap-6 overflow-x-auto pb-6">
          ...
          <div data-od-id="phone-mockup-together"><PhoneMockup label="함께" subtitle="배우자 연결 상태"><TogetherScreenPreview /></PhoneMockup></div>
          <div data-od-id="phone-mockup-settings"><PhoneMockup label="설정" subtitle="계정 · FIRE 가정 · 면책"><SettingsScreenPreview /></PhoneMockup></div>
        </div>

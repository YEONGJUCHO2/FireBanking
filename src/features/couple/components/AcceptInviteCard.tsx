...
export function AcceptInviteCard({ token }: { token: string }) {
  ...
  return (
    <section className="fb-card p-6">
      <div className="mx-auto mb-6 flex size-20 items-center justify-center rounded-full bg-fb-card-alt text-3xl">
        ✉
      </div>
      <div className="grid gap-2 text-center">
        <p className="text-sm font-bold text-fb-trust">초대 수락</p>
